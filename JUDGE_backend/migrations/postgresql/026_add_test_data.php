...
class Migration_Add_test_data extends CI_Migration {
    ...
    public function up()
    {
        ...
        $sql = "INSERT INTO admin (email, password)
                VALUES ('admin@test.com', crypt('password', gen_salt('bf')));";

        $this->db->query($sql);

        $sql = "INSERT INTO summit(created_by_admin_id, summit_start, summit_end, registration_deadline, pin)
                VALUES (1, NOW(), '2018-12-31 23:59:59', '2018-12-31 23:59:59', crypt('1234', gen_salt('bf')));";
    ...
    public function down()
    {
        ...
        $sql = "DELETE FROM admin
                WHERE email = 'admin@test.com' AND password = crypt('password', password);";

        $this->db->query($sql);

        $sql = "DELETE FROM summit
                WHERE created_by_admin_id = 1 AND summit_end = '2018-12-31 23:59:59' AND registration_deadline = '2018-12-31 23:59:59' AND pin = crypt('1234', pin);";
